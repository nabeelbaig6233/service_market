...
$(".image-upload").on('click', 'i', function () {
  ...
  $(this).parents('.image-upload').children('img').attr('src', baseUrl + '/assets/admin/images/placeholder.png');
  $(this).remove();
});
...
module.exports = __webpack_require__(/*! D:\xampp\htdocs\service_market\resources\js\admin\custom.js */"./resources/js/admin/custom.js");
